 ...
 * @author NANO
 */
public class JumatEdit extends javax.swing.JDialog {
    ...
    public JumatEdit(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel18.setText("Edit Pengguna Laboratorium Hari Jumat");
    ...
    private void EditButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditButtonActionPerformed
        try {
            ...
            String query = "select * from jumat where JAM =?";
            PreparedStatement pst = Kelas_Database.Koneksi().prepareStatement(query);
            pst.setString(1, jam);
            ResultSet rset;
            rset = pst.executeQuery();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ...
            String query = "INSERT into jumat values ('" + jam + "','" + basdat_A + "','" + basdat_B + "','"
    ...
    private void HapusButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HapusButtonActionPerformed
        ...
        try {
            ...
            Statement statement = con.createStatement();
            String query = "delete from jumat where jam ='" + CariJAM + "'";
    ...
    private void SimpanButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SimpanButtonActionPerformed
        try {
            String query = "UPDATE jumat set BASDAT_A='" + Basdat_Atextfild.getText() + "',BASDAT_B='"
