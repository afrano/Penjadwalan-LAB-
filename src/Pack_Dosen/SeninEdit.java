 ...
 * @author NANO
 */
public class SeninEdit extends javax.swing.JDialog {

    /**
     * Creates new form SeninEdit
     */
    private Connection con = Kelas_Database.Koneksi();
    private String jam, basdat_A, basdat_B, basdat_C, Jarkom_A, Jarkom_B, Jarkom_C;

    public SeninEdit(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void lihatdijam() {
        try {
            String query = "select * from Senin where JAM =?";
            PreparedStatement pst = Kelas_Database.Koneksi().prepareStatement(query);
    ...
    public void tambahjam() {
        try {
            ...
            String query = "INSERT into senin values ('" + jam + "','" + basdat_A + "','" + basdat_B + "','"
    ...
    public void EditJam() {
        try {
            ImageIcon icon = new ImageIcon("src/Gambar/Logo USD.png");
            setIconImage(icon.getImage());
            String jam = (String) JOptionPane.showInputDialog(rootPane, "Masukan jam yang akan di edit", 
                    "Perintah Edit", 0, icon, null, null);
            String query = "select * from senin where JAM =?";
            PreparedStatement pst = Kelas_Database.Koneksi().prepareStatement(query);
            pst.setString(1, jam);
            ResultSet rset;
    ...
    public void SimpanEditan() {
        try {
            String query = "UPDATE senin set BASDAT_A='" + Basdat_Atextfild.getText() + "',BASDAT_B='"
    ...
    private void initComponents() {
        ...
        jLabel18.setText("Edit Pengguna Laboratorium Hari Senin");
        ...
        TambahButton.setText("Tambahkan Jam");
